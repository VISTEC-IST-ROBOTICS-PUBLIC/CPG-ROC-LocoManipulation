/*****************************************************************************
 *  Copyright (C) 2021 by Binggwong Leung                                    *
 *                                                                           *
...
public:
    ...
    void postProcessing();
    void updateLoss(float targetPose1, float currentPose1, float targetPose2, float currentPose2);
