...
void PCPGtest::updateOutputs(){
	...
	//
			...
			yup.at(0) = ((2./deltaxup.at(0))*xup.at(0))-lastoutput_stance[0];
			////////////Scaling  Slope Down calculation//////
			ydown.at(0) = ((-2./deltaxdown.at(0))*xdown.at(0))+1;


			////////////Scaling Slope Up calculation////////
			yup.at(1) = ((2./deltaxup.at(1))*xup.at(1))-lastoutput_stance[1];
			////////////Scaling  Slope Down calculation//////
			ydown.at(1) = ((-2./deltaxdown.at(1))*xdown.at(1))+1;

// cout << "countup   : " << countup.at(0) << endl;
// cout << "countdown : " << countdown.at(0) << endl;
