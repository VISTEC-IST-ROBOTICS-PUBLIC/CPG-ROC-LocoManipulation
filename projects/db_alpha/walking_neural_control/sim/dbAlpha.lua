...
function sysCall_init()
    ...
    -- Handle
    robotHandle = sim.getObject("/Alpha_Base")
    ballHandle = sim.getObject("/Sphere_C")    
    ball_pos = {}
    motor_string = {"BC", "CF", "FT"}
    jointHandle = {}
    jointPos = {}
    jointVel = {}
    jointTorque = {}
    ...
    jointHandle[joint_count] = sim.getObject("/TA")
    ...
    result=sim.launchExecutable('../workspace/CPG-ROC_BallRolling/projects/db_alpha/walking_neural_control/sim/ros2_ws/src/walking_neural_controller_sim/bin/db_beta_controller_sim', 'test',0)
    print('result: ' .. result)
